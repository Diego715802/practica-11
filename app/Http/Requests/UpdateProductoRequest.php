...
class UpdateProductoRequest extends FormRequest // (Cambia el nombre de la clase a UpdateProductoRequest en el otro archivo)
{
    public function authorize(): bool
    {
        // Ya lo protegimos con Gates en el controlador, así que aquí lo dejamos pasar
        return true;
    }
